...
arch() {
	...
	sudo pacman -S cliphist foot fuzzel grim hypridle hyprland hyprlock hyprpolkitagent mako qt6-wayland satty slurp swaybg waybar wl-clipboard xdg-desktop-portal-hyprland xwayland-satellite # wayland
