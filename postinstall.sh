...
arch() {
	...
	sudo pacman -S --noconfirm clipmenu dunst maim nsxiv unclutter xcape xclip xcompmgr xdg-desktop-portal-gtk xdo xfce4 xorg-server xorg-xinit xorg-xinput xorg-xrandr xwallpaper # xorg
