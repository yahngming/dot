...
arch() {
	...
	sudo pacman -S cliphist foot fuzzel grim hyprland hyprpolkitagent mako niri qt6-wayland satty slurp swaybg swaylock swayidle waybar wl-clipboard wlr-randr xdg-desktop-portal-hyprland xwayland-satellite # wayland
