...
arch() {
	...
	yay -S --noconfirm bibata-cursor-git chicago95-theme ctpv-git dragon-drop google-chrome newsraft python-pywalfox r-quick-share sing-box #base
