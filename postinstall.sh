...
arch() {
	...
	sudo pacman -Syy
	sudo pacman -S bluez bluez-utils brightnessctl evtest intel-media-driver lib32-vulkan-intel lib32-vulkan-radeon mesa pipewire-jack udiskie vulkan-intel vulkan-radeon # driver
