...
arch() {
	sudo pacman -Syu aerc atool base-devel bat bc btop clash cmus eza fastfetch fcitx5-chinese-addons fcitx5-im fd ffmpegthumbnailer firefox fzf git git-delta glow gvim imlib2 jq less lf libxss lolcat maim man-db mpv noto-fonts noto-fonts-cjk noto-fonts-emoji nsxiv openssh pass perl-file-mimeinfo perl-image-exiftool polkit poppler python-pywal steam trash-cli ttf-nerd-fonts-symbols ueberzug xcape xclip xcompmgr xdo xorg-xrandr xssstate xwallpaper zoxide
	mkdir -p ~/.local/src
