...
arch() {
	...
	sudo pacman -S cliphist foot fuzzel grim hyprland hyprpolkitagent mako qt6-wayland satty slurp swaybg swaylock swayidle waybar wl-clipboard xdg-desktop-portal-hyprland xwayland-satellite # wayland
