...
other packages
```sh
yay android-tools blender darktable doomrunner freecad google-chrome gyroflow hugin krita minecraft-launcher openrgb prusa-slicer rpi-imager tsukimi-git uzdoom
