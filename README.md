...
other packages
```sh
yay android-tools blender darktable doomrunner freecad google-chrome gyroflow hugin krita minecraft-launcher openrgb orca-slicer-bin rpi-imager tsukimi-git uzdoom
