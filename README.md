...
other packages
```sh
yay android-tools betaflight-configurator blender darktable doomrunner expresslrs-configurator freecad gyroflow gzdoom hugin krita minecraft-launcher orca-slicer rpi-imager sdrpp-git tsukimi-git
