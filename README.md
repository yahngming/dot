...
other packages
```sh
yay betaflight-configurator blender darktable docker docker-compose doomrunner expresslrs-configurator freecad gyroflow gzdoom hugin krita minecraft-launcher orca-slicer rpi-imager sdrpp-git tsukimi-git
