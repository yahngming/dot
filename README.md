...
other packages
```sh
yay android-tools betaflight-configurator blender darktable doomrunner expresslrs-configurator freecad gyroflow hugin krita minecraft-launcher openrgb prusa-slicer rpi-imager sdrpp-git tsukimi-git uzdoom
