...
other packages
```sh
yay android-tools betaflight-configurator blender darktable doomrunner expresslrs-configurator freecad gyroflow hugin krita minecraft-launcher openrgb orca-slicer rpi-imager sdrpp-git uzdoom
