...
sudo pacman -S base-devel btop cmatrix fcitx5-chinese-addons fcitx5-im firefox git man-db mpv neofetch nnn noto-fonts noto-fonts-cjk noto-fonts-emoji ttf-nerd-fonts-symbols python-pywal vim xdotool xwallpaper xorg-xrandr
